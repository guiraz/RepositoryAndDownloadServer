...
var touchOrReplace = function (path) {
    mkdirp.sync(path_mod.dirname(path));
    touch.sync(path);
};
exports.touchOrReplace = touchOrReplace;
...
exports.writeReplaceTruncate = function(file, data, cb){
    fs.writeFile(file, data, {'flag': 'w+'}, cb);
};
